...
const PopoverModal = PopoverPrimitive.Root;

const PopoverModalTrigger = PopoverPrimitive.Trigger;

const PopoverModalContent = React.forwardRef<
...
PopoverModalContent.displayName = PopoverPrimitive.Content.displayName;

export { PopoverModal, PopoverModalTrigger, PopoverModalContent };
